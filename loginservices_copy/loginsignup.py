...
#This is called by setjws service
    if request.method=='OPTIONS':
        ...
        return 'inside SATNATKEY options'
        ...
        command = cur.mogrify("SELECT lguserid,lgusername,lgusertype,lgentityid FROM userlogin WHERE lguserid = %s AND lguserstatus = 'A';",(uid,) )
        print(command)
